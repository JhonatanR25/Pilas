...
namespace Evaluator.UI.Windows
{
    public class CalculatorForm : Form
    {
        ...
        private void BuildUi()
        {
            ...
            // Layout principal: 1) display (panel único con dos filas internas), 2) teclas
            ...
            layout.RowStyles.Add(new RowStyle(SizeType.Absolute, 92));   // recuadro superior (único)
            layout.RowStyles.Add(new RowStyle(SizeType.Percent, 100));   // grid teclas
            card.Controls.Add(layout);

            // ===== Recuadro único (2 filas adentro) =====
            ...
            displayGrid.RowStyles.Add(new RowStyle(SizeType.Absolute, 44)); // operación
            displayGrid.RowStyles.Add(new RowStyle(SizeType.Absolute, 36)); // resultado
            display.Controls.Add(displayGrid);

            // Operación (una sola línea, sin borde interno)
            txtExpr = new TextBox
            {
                Dock = DockStyle.Fill,
            ...
            // Resultado (una sola línea, solo lectura, sin borde interno)
            ...
            // Filas con el intercambio solicitado:
            // Derecha fila1: +
            // Derecha fila2: -
            AddRow("7", "8", "9", "+");
            AddRow("4", "5", "6", "-");
            AddRow("1", "2", "3", "/");
            AddRow("0", ".", "(", ")");
            // Fila inferior operadores: Del, Clr, *, ^
            AddRow("Del", "Clr", "*", "^");

            // Fila final: "=" ocupa las 4 columnas
        ...
        // ===== Panel redondeado para el recuadro superior =====
